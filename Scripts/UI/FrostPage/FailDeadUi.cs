...
public class FailDeadUi : MonoBehaviour
{
    private static FailDeadUi instance = null;
    public static FailDeadUi Instance
    {
        get { return instance; }
    }
    public void Awake()
    ...
    void Start()
    {
        ...
        GameApiManager.Instance.ReqGameFinsh(clearTime, false, roomSeq, startTime, 0, gameLevel);
    }
