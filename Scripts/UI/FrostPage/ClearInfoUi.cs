...
{
    private static ClearInfoUi instance = null;
    public static ClearInfoUi Instance
    {
        get { return instance; }
    }
    public void Awake()
    ...
    void Start()
    {
        ...
        GameApiManager.Instance.ReqGameFinsh(clearTime, true, roomSeq, startTime, 2, gameLevel);
    }
    void Update()
    {
        ...
        if (nowGauge <= maxGauge && slicedImage != null)
        {
            ...
            slicedImage.fillAmount = nowGauge / maxGauge;
