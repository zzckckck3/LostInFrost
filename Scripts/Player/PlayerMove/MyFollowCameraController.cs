...
{
    public sealed class MyFollowCameraController : MonoBehaviour
    {
        ...
        {
            transform.position = Vector3.Lerp(transform.position, cameraRelativePosition, followSpeed * Time.fixedDeltaTime);
        }
